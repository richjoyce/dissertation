...
\begin{figure}
    \centering
    \includegraphics[width=4.0in]{{rmse_tracking_trials.4.0x4.0}.png}
...
\subsubsection{Correct Prompts}

\begin{figure}
    \centering
    \includegraphics[width=4.0in]{{correct_prompts.4.0x4.0}.png}
    \caption{Factor Plot of Percent of Correct Prompts per Trial}
...
\begin{figure}
    ...
    \caption{Average percent of correct, incorrect, and incomplete prompts.}
