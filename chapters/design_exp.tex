...
\begin{figure}
    ...
    \caption{RMSE for Tracking Only Trials by Group and Design}
    \label{fig:de_factor_training}
\end{figure}

The two-way ANOVA found Group to be a marginally significant factor ($F(1, 21) = 4.94, p=0.037$) between the VR Group ($M=\ang{1.36}, \sigma=\ang{0.51}$) and the TS Group ($M=\ang{0.94}, \sigma=\ang{0.43}$).
