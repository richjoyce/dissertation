...
\todo[inline]{major points were noted by both groups. nothing that group 1 mentioned that group 2 didn't, but numbers are different}

\todo[inline]{flaws of the system are more evident in the VR group}

\todo[inline]{time pressured tasks propvide different results.}

\todo[inline]{time measurement may not be accurate unless .}

\todo[inline]{visual acuity of the display does not affect the task as strongly when time measurement may not be accurate unless .}

\todo[inline]{subjects are not domain experts, however task was simple}

\todo[inline]{evaluation of feedback could have been done blind}
% A blind evaluation of the feedback may have been better

\todo[inline]{interview was not undertaken for two reasons, one was the subject population, the other was that rigidity removed bias}
...
\todo[inline]{hand tracker based input may prove chalelnging for motor constrained tasks, howeber for cognitive based tasks it is more valid}

\todo[inline]{performance based measures using other modalities of input may be valid.}

\todo[inline]{would this hold if had better simulation quality on VR ie. out the windows}
