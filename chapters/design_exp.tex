...
For the evaluation sessions with each design, subjects performed six trials with both tasks.
The first three were a minute long.
They were considered practice trials, and not included in the data analysis, though this was not communicated to the subjects.
...
The prompting task has two dependent measures: speed and accuracy.
...
Twelve prompts are shown to the subject in each trial.
