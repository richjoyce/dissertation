...
We found that a button targetting task took more time in our virtual environment than in the real world (Chapter \ref{chap:pointing}).
...
The simulator workstation as configured for each group is \tinytodo{this is not done yet}shown and annotated in Figure \ref{fig:de_simgroups}.
...
\todo[inline]{Include a short overview of the hand tracker system}
...
The flight condition is listed as ``Flight Condition 2'' in NASA CR-2144\cite{heffley_aircraft_1972}.
...
It is designed to provide a broad spectrum of frequencies for human pilot freqeuncy response identifications \citep{mcruer_mathematical_1974}.
