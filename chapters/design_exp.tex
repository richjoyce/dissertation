...
One group used an R3C setup to operate the instrument, while the other used a more traditional touchscreen simulator of the instrument.
...
The buttons are slightly smaller in this design, at \SI{0.76}{\inch} by \SI{0.55}{\inch}.
...
The TS group performed closer to their performance in the Keypad design, however, with only about 1 fewer prompt correct on average.
