...
\begin{figure}
    ...
    \caption{RMSE (root mean square error) of the tracking task by Group and Design.}
...
\begin{figure}
    ...
    \caption{RMSE of tracking task for tracking only trials by Group and Design.}
...
\begin{figure}
    ...
    \caption{Prompt Response Time (milliseconds) by Group and Design.}
...
\begin{figure}
    ...
    \caption{Percent of Correct Prompts per Trial by Group and Design.}
...
\begin{figure}
    ...
    \caption{NASA-TLX workload scores by Group and Design.}
...
\begin{figure}
    ...
    \caption{RMSE for Tracking Only Trials by Group and Trial.}
