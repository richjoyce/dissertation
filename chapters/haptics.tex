...
% Connect back to the first trial based restuls
...
The post-hoc repeated measures ttest between haptics conditions for the PH First group showed a significant effect ($t(9)=4.58, p=0.001$) between arm fatigue scores in the PH condition ($M=11.7, \sigma=3.01$) and the NH condition ($M=14.5, \sigma=3.53$).
