...
\subsection{Ballistic Filtering}
...
The arm fatigue scores had a significant effect for Haptics ($F(1,18)=9.72, p<0.01$) between the Passive Haptics condition ($M=13.45, \sigma=3.76$) and the No Haptics condition ($M=14.72, \sigma=2.85$).
There was no effect due to Sequence ($F(1,18)=2.12, p=0.16$).
However, the interaction effect between the two effects was significant ($F(1,18)=13.9, p<0.01$).
The post-hoc repeated measures ttest for the PH First group showed a significant effect ($t(9)=-4.58, p<0.07$) between arm fatigue scores in the PH condition ($M=11.7, \sigma=3.01$) and the NH condition ($M=14.5, \sigma=3.53$).
