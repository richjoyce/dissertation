...
\begin{figure}
    ...
    \caption{Throughput per trial. The learning curve exponential fit is given by Eq.~\ref{eq:ph_learning} with parameters from Table~\ref{tab:ph_tp_regression}. Error bars are standard error of the mean. Each line represents one of the counterbalanced sequence groups (those who did NH as their first condition versus those who did PH as their first condition).}
...
\begin{figure}
    ...
    \caption{Arm Fatigue by Trial. Translucent bands are the standard error of the mean. Each line represents one of the counterbalanced sequence groups (those who did NH as their first condition versus those who did PH as their first condition).}
...
The results indicate that the use of passive haptics changes the targeting time and accuracy of reaching movements.
