...
\begin{figure}
    ...
    \caption{Throughput per trial. The learning curve exponential fit is given by Eq.~\ref{eq:ph_learning} with parameters from Table~\ref{tab:ph_tp_regression}. Error bars are standard error of the mean.}
...
\begin{figure}
    ...
    \caption{Arm Fatigue by Trial. Translucent bands are the standard error of the mean.}
