...
The histograms of these metrics as well as more sample movements are shown in Appendix~\ref{sec:app_ph_metrics}.
...
\begin{figure}
    ...
    \caption{Throughput results by haptics and sequence.}
    \label{fig:ph_throughput}
\end{figure}

In this section, we investigate the first research question, \textit{Will Fitts' throughput be higher with passive haptics?}.
The throughput results are listed by haptic condition in Table~\ref{tab:ph_throughput_fulltable}.
Figure~\ref{fig:ph_throughput} shows the throughput seperated by haptics and sequence (the order the subjects performed the haptic conditions).
...
\begin{figure}
    ...
    \caption{Time spent in each trajectory phase by haptics.}
    \label{fig:ph_phases}
\end{figure}
