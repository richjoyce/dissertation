...
As previously described (Chapter \ref{sec:proto_button_detection}), the hand tracker mounted above the panel enables detection of when the user presses a button without need for a touch sensor.
