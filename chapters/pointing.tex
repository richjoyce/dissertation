...
Often, the researchers indicate that incorrect trials were discarded or redone without noting the frequency of errors.
...
This provides a position accuracy of under \SI{0.1}{\inch} when a user contacts the button.
...
When the finger of the user enters the detection box and remains inside for \SI{50}{\milli\second}, the button press even is activated.
