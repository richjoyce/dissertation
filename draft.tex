...
\lhead{}
\cfoot{---\thepage---}
\fancyheadoffset[RE,RO]{\myoddoffset}
\fancyfootoffset[RE,RO]{\myoddoffset}
...
\input{introduction} %This looks for chapter1.tex

% chapter 2
\chapter{Real Title Here}
\input{prototype} %This looks for chapter2.tex

% chapter 3
\chapter{Real Title Here}
\input{validation} %This looks for chapter2.tex

% chapter 4
\chapter{Real Title Here}
\input{haptics} %This looks for chapter2.tex

% chapter 5
\chapter{Real Title Here}
\input{design_exp} %This looks for chapter2.tex

% chapter 6
\chapter{Real Title Here}
\input{conclusion} %This looks for chapter2.tex
